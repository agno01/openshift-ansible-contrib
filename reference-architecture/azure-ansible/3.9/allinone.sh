...
subscription-manager repos --enable="rhel-7-server-rpms" --enable="rhel-7-server-extras-rpms" --enable="rhel-7-fast-datapath-rpms" --enable="rhel-7-server-ansible-2-rpms"
...
cat <<EOF >> /home/${AUSERNAME}/subscribe.yml
  ...
  - name enable Ansible repos
    shell: subscription-manager repos --enable="rhel-7-server-ansible-2-rpms"
